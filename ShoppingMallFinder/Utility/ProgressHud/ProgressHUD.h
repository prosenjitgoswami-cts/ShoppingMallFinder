...
@property (assign) CGSize hudSize;

@property (atomic, MB_STRONG,readonly) UIView *indicator;

@property (nonatomic,MB_STRONG,readonly) UILabel *label;
 ...
 */
@property (nonatomic, MB_STRONG,readonly) UIColor *backgroundTintColor;
